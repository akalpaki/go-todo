...
const (
	...
	selectTodosByAuthorIDQuery = "SELECT id, name, author_id FROM todos WHERE author_id = $1 ORDER BY id LIMIT $2 OFFSET $3"
	insertTodoQuery            = "INSERT INTO todos (id, name, author_id) VALUES ($1, $2, $3)"
